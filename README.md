...
## SQL
The supported SQL syntax description can be found in [IMDG SQL docs](https://docs.hazelcast.com/imdg/4.2/sql/distributed-sql.html). Hazelcast Jet 4.5 that supports the JDBC driver will be released soon. You can take a look at its SQL capabilities in the [Jet SQL documentations](https://jet-start.sh/docs/get-started/intro). 
